...
namespace Library
{
	...
	public class TextBox1
	{
		...
		public PictureBox Ris(MouseEventArgs e, TextBox textBox, ref Queue <string> SaveText)
		{
			...
			gr.DrawString(textBox.Text, new Font("Times New Roman", 10), Brushes.Black, new PointF(x1 - x2 - 26, y1));
			gr.Dispose();
			return picture;
		}
		/// <summary>
		...
		public PictureBox Paint(MouseEventArgs e, TextBox textBox, ref string[] mas, int i)
		{
			...
			x = mas[i];
			int x2 = x.Length;
			gr.DrawString(mas[i], new Font("Times New Roman", 10), Brushes.Black, new PointF(x1 - x2 - 26, y1));
			gr.Dispose();
			return picture;
		}
